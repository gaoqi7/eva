...
function Ap (seq, reqDate, evaPayDay, amount, localPayDay, localPayType, chequeNum, vendorCode, vendorName) {
  this.seq = seq
...
worksheet.spliceRows(rowNumber-1,10)
  ...
  seqList.forEach(el => {
    ...
    const i = new Ap(seq, reqDate, evaPayDay, amount, localPayDay, localPayType, chequeNum, vendorCode, vendorName)
    apList.push(i)
  })
